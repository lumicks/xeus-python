...
wasm_interpreter::wasm_interpreter() : interpreter(true, true) { m_release_gil_at_startup = false; }
...
bool wasm_interpreter::use_jedi_for_completion() const { return false; }
} // namespace xpyt
