...
bool should_include(const std::string& mimetype, const std::vector<std::string>& include) {
    return include.size() == 0
           || std::find(include.cbegin(), include.cend(), mimetype) != include.end();
}

bool should_exclude(const std::string& mimetype, const std::vector<std::string>& exclude) {
    return exclude.size() != 0
           && std::find(exclude.cbegin(), exclude.cend(), mimetype) != exclude.end();
}

void compute_repr(const py::object& obj, const std::string& repr_method,
                  const std::string& mimetype, const std::vector<std::string>& include,
                  const std::vector<std::string>& exclude, py::dict& pub_data,
                  py::dict& pub_metadata) {
    if (hasattr(obj, repr_method.c_str()) && should_include(mimetype, include)
        && !should_exclude(mimetype, exclude)) {
...
py::tuple mime_bundle_repr(const py::object& obj, const std::vector<std::string>& include = {},
...
py::handle bind_display_hook() {
    static auto h =
        py::class_<xdisplayhook>({}, "DisplayHook")
            .def(py::init<>())
...
void xdisplayhook::set_execution_count(int execution_count) { m_execution_count = execution_count; }
...
void xdisplay_impl(xeus::xinterpreter* xint, const py::args objs,
                   const std::vector<std::string>& include, const std::vector<std::string>& exclude,
                   const py::dict& metadata, const py::object& transient,
                   const py::object& display_id, bool update, bool raw) {
    for (std::size_t i = 0; i < objs.size(); ++i) {
        ...
        if (!obj.is_none()) {
            ...
            if (update) {
                xint->update_display_data(pub_data, pub_metadata, std::move(cpp_transient));
            } else {
                xint->display_data(pub_data, pub_metadata, std::move(cpp_transient));
            }
        }
    }
}

void xdisplay(xeus::xinterpreter* xint, py::args objs, py::kwargs kw) {
    auto raw = kw.contains("raw") ? kw["raw"].cast<bool>() : false;
    auto include = kw.contains("include") ? kw["include"].cast<std::vector<std::string>>()
                                          : std::vector<std::string>();
    auto exclude = kw.contains("exclude") ? kw["exclude"].cast<std::vector<std::string>>()
                                          : std::vector<std::string>({});
    ...
    xdisplay_impl(xint, objs, include, exclude, metadata, transient, display_id, false, raw);
}

void xupdate_display(xeus::xinterpreter* xint, py::args objs, py::kwargs kw) {
    auto raw = kw.contains("raw") ? kw["raw"].cast<bool>() : false;
    auto include = kw.contains("include") ? kw["include"].cast<std::vector<std::string>>()
                                          : std::vector<std::string>();
    auto exclude = kw.contains("exclude") ? kw["exclude"].cast<std::vector<std::string>>()
    ...
    xdisplay_impl(xint, objs, include, exclude, metadata, transient, display_id, true, raw);
}

void xpublish_display_data(xeus::xinterpreter* xint, const py::object& data,
                           const py::object& metadata, const py::str& /*source*/,
                           const py::object& transient) {
    xint->display_data(data, metadata, transient);
}

void xdisplay_mimetype(xeus::xinterpreter* xint, const std::string& mimetype, py::args objs,
                       py::kwargs kw) {
    ...
    xdisplay_impl(xint, disp_objs, {mimetype}, {}, p_metadata, py::none(), py::none(), false, raw);
}
...
public:
    xdisplay_object(const py::object& data, const py::object& url, const py::object& filename,
                    const py::object& metadata = py::dict(), const std::string& read_flag = "r");
...
py::handle bind_display_object() {
    static auto h =
        py::class_<xdisplay_object>({}, "DisplayObject")
            .def(py::init<const py::object&, const py::object&, const py::object&,
                          const py::object&>(),
                 py::arg("data") = py::none(), py::arg("url") = py::none(),
                 py::arg("filename") = py::none(), py::arg("metadata") = py::none())
            .def("reload", &xdisplay_object::reload)
            .def_property("data", &xdisplay_object::get_data, &xdisplay_object::set_data)
            .def_property("metadata", &xdisplay_object::get_metadata,
                          &xdisplay_object::set_metadata)
            .release();
    return h;
}
...
xdisplay_object::xdisplay_object(const py::object& data, const py::object& url,
                                 const py::object& filename, const py::object& metadata,
                                 const std::string& read_flag)
...
py::object xdisplay_object::get_metadata() { return m_metadata; }

void xdisplay_object::set_metadata(const py::object& data) { m_metadata = data; }

py::object xdisplay_object::get_data() { return m_data; }

void xdisplay_object::set_data(const py::object& data) { m_data = data; }
...
public:
    xtext_display_object(const py::object& data, const py::object& url, const py::object& filename,
                         const py::object& metadata = py::dict());
    virtual ~xtext_display_object();
};

py::handle bind_text_display_object() {
    static auto h = py::class_<xtext_display_object, xdisplay_object>({}, "TextDisplayObject")
                        .def(py::init<const py::object&, const py::object&, const py::object&,
                                      const py::object&>(),
                             py::arg("data") = py::none(), py::arg("url") = py::none(),
                             py::arg("filename") = py::none(), py::arg("metadata") = py::none())
...
xtext_display_object::xtext_display_object(const py::object& data, const py::object& url,
                                           const py::object& filename, const py::object& metadata)
...
public:
    xhtml(const py::object& data, const py::object& url, const py::object& filename,
          const py::object& metadata);
    virtual ~xhtml();
...
py::handle bind_html() {
    static auto h = py::class_<xhtml, xdisplay_object>({}, "HTML")
                        .def(py::init<const py::object&, const py::object&, const py::object&,
                                      const py::object&>(),
                             py::arg("data") = py::none(), py::arg("url") = py::none(),
                             py::arg("filename") = py::none(), py::arg("metadata") = py::none())
...
xhtml::xhtml(const py::object& data, const py::object& url, const py::object& filename,
             const py::object& metadata)
    : xdisplay_object(data, url, filename, metadata) {}

xhtml::~xhtml() {}

py::object xhtml::repr_html() const { return data_and_metadata(); }

py::object xhtml::html() const { return repr_html(); }
...
public:
    xjavascript(const py::object& data, const py::object& url, const py::object& filename,
                const py::object& lib, const py::object& css);
    virtual ~xjavascript();
...
py::handle bind_javascript() {
    static auto h = py::class_<xjavascript, xtext_display_object>({}, "Javascript")
                        .def(py::init<const py::object&, const py::object&, const py::object&,
                                      const py::object&, const py::object&>(),
                             py::arg("data") = py::none(), py::arg("url") = py::none(),
                             py::arg("filename") = py::none(), py::arg("lib") = py::none(),
                             py::arg("css") = py::none())
...
xjavascript::xjavascript(const py::object& data, const py::object& url, const py::object& filename,
                         const py::object& lib, const py::object& css)
...
py::object xjavascript::repr_javascript() {
    ...
    for (py::handle css : m_css) {
        string_stream
            << R"($("head").append($("<link/>").attr({rel:  "stylesheet", type: "text/css", href: ")";
...
public:
    xmarkdown(const py::object& data, const py::object& url, const py::object& filename,
              const py::object& metadata);
    virtual ~xmarkdown();
...
py::handle bind_markdown() {
    static auto h = py::class_<xmarkdown, xdisplay_object>({}, "Markdown")
                        .def(py::init<const py::object&, const py::object&, const py::object&,
                                      const py::object&>(),
                             py::arg("data") = py::none(), py::arg("url") = py::none(),
                             py::arg("filename") = py::none(), py::arg("metadata") = py::none())
...
xmarkdown::xmarkdown(const py::object& data, const py::object& url, const py::object& filename,
                     const py::object& metadata)
    : xdisplay_object(data, url, filename, metadata) {}

xmarkdown::~xmarkdown() {}

py::object xmarkdown::repr_markdown() const { return data_and_metadata(); }
...
public:
    xmath(const py::object& data, const py::object& url, const py::object& filename,
          const py::object& metadata);
    virtual ~xmath();
...
py::handle bind_math() {
    static auto h = py::class_<xmath, xdisplay_object>({}, "Math")
                        .def(py::init<const py::object&, const py::object&, const py::object&,
                                      const py::object&>(),
                             py::arg("data") = py::none(), py::arg("url") = py::none(),
                             py::arg("filename") = py::none(), py::arg("metadata") = py::none())
...
xmath::xmath(const py::object& data, const py::object& url, const py::object& filename,
             const py::object& metadata)
    : xdisplay_object(data, url, filename, metadata) {}
...
public:
    xlatex(const py::object& data, const py::object& url, const py::object& filename,
           const py::object& metadata);
    virtual ~xlatex();
...
py::handle bind_latex() {
    static auto h = py::class_<xlatex, xdisplay_object>({}, "Latex")
                        .def(py::init<const py::object&, const py::object&, const py::object&,
                                      const py::object&>(),
                             py::arg("data") = py::none(), py::arg("url") = py::none(),
                             py::arg("filename") = py::none(), py::arg("metadata") = py::none())
...
xlatex::xlatex(const py::object& data, const py::object& url, const py::object& filename,
               const py::object& metadata)
    : xdisplay_object(data, url, filename, metadata) {}

xlatex::~xlatex() {}

py::object xlatex::repr_latex() const { return data_and_metadata(); }
...
public:
    xsvg(const py::object& data, const py::object& url, const py::object& filename,
         const py::object& metadata);
    virtual ~xsvg();
...
py::handle bind_svg() {
    static auto h = py::class_<xsvg, xdisplay_object>({}, "SVG")
                        .def(py::init<const py::object&, const py::object&, const py::object&,
                                      const py::object&>(),
                             py::arg("data") = py::none(), py::arg("url") = py::none(),
                             py::arg("filename") = py::none(), py::arg("metadata") = py::none())
...
xsvg::xsvg(const py::object& data, const py::object& url, const py::object& filename,
           const py::object& metadata)
...
py::object xsvg::repr_svg() const { return data_and_metadata(); }
...
public:
    xjson(const py::object& data, const py::object& url, const py::object& filename,
...
py::handle bind_json() {
    static auto h = py::class_<xjson>({}, "JSON")
                        .def(py::init<const py::object&, const py::object&, const py::object&,
                                      const py::bool_&, const py::object&, const py::str&>(),
                             py::arg("data") = py::none(), py::arg("url") = py::none(),
                             py::arg("filename") = py::none(), py::arg("expanded") = false,
                             py::arg("metadata") = py::none(), py::arg("root") = "root")
                        .def("_repr_json_", &xjson::repr_json)
                        .release();
    return h;
}

xjson::xjson(const py::object& data, const py::object& url, const py::object& filename,
             const py::bool_& expanded, const py::object& metadata, const py::str& root)
    : xdisplay_object(data, url, filename, metadata) {
    if (get_metadata().is_none()) {
...
py::object xjson::repr_json() const { return data_and_metadata(); }
...
public:
    xgeojson(const py::object& data, const py::object& url, const py::object& filename,
             const py::bool_& expanded, const py::object& metadata, const py::str& root,
...
py::handle bind_geojson() {
    static auto h =
        py::class_<xgeojson, xjson>({}, "GeoJSON")
            .def(py::init<const py::object&, const py::object&, const py::object&, const py::bool_&,
                          const py::object&, const py::str&, const py::dict&, const py::str&>(),
                 py::arg("data") = py::none(), py::arg("url") = py::none(),
                 py::arg("filename") = py::none(), py::arg("expanded") = false,
                 py::arg("metadata") = py::none(), py::arg("root") = "root",
...
xgeojson::xgeojson(const py::object& data, const py::object& url, const py::object& filename,
                   const py::bool_& expanded, const py::object& metadata, const py::str& root,
                   const py::dict& layer_options, const py::str& url_template)
    : xjson(data, url, filename, expanded, metadata, root), m_layer_options(layer_options),
...
void xgeojson::ipython_display() {
    py::dict bundle = py::dict("application/geo+json"_a = get_data(),
                               "text/plain"_a = "<IPython.display.GeoJSON object>");
    py::dict metadata = py::dict("application/geo+json"_a = get_metadata());

    xdisplay(&xeus::get_interpreter(), bundle, py::kwargs());
}
...
py::handle bind_progressbar() {
    static auto h =
        py::class_<xprogressbar>({}, "ProgressBar")
...
xprogressbar::xprogressbar(std::ptrdiff_t total) : m_total(total), m_id(xeus::new_xguid()) {}

std::string xprogressbar::repr() const {
    double fraction = double(m_progress) / double(m_total);
    std::size_t len_filled =
        static_cast<std::size_t>(floor(fraction * static_cast<double>(m_text_width)));
...
std::string xprogressbar::repr_html() const {
    std::ostringstream string_stream;
    string_stream << "<progress style='width:60ex' max='" << m_total << "' value='" << m_progress
                  << "'></progress>";
...
std::ptrdiff_t xprogressbar::get_progress() const { return m_progress; }
...
std::ptrdiff_t xprogressbar::get_total() const { return m_total; }
...
void xprogressbar::display(bool update) const {
    ...
    if (!update) {
        interp.display_data(std::move(pub_data), nl::json::object(), std::move(cpp_transient));
    } else {
        interp.update_display_data(std::move(pub_data), nl::json::object(),
...
py::object pngxy(const py::object& data) {
    ...
    std::size_t ihdr =
        data.attr("index")(builtins.attr("bytes")("IHDR", "UTF8")).cast<std::size_t>();
...
py::module get_display_module_impl(xeus::xinterpreter* xint) {
    ...
    display_module.attr("DisplayHook") = bind_display_hook();

    display_module.def("display",
                       [xint](py::args objs, py::kwargs kw) { xdisplay(xint, objs, kw); });
    display_module.def("update_display",
                       [xint](py::args objs, py::kwargs kw) { xupdate_display(xint, objs, kw); });

    display_module.def(
        "publish_display_data",
        [xint](const py::object& data, const py::object& metadata, const py::str& /*source*/,
               const py::object& transient) {
            xpublish_display_data(xint, data, metadata, {}, transient);
        },
        py::arg("data"), py::arg("metadata") = py::dict(), py::arg("source") = py::str(),
        py::arg("transient") = py::dict());

    display_module.def(
        "clear_output", [xint](bool wait) { xint->clear_output(wait); }, py::arg("wait") = false);

    display_module.def("display_html", [xint](py::args objs, py::kwargs kw) {
        xdisplay_mimetype(xint, "text/html", objs, kw);
    });
    display_module.def("display_markdown", [xint](py::args objs, py::kwargs kw) {
        xdisplay_mimetype(xint, "text/markdown", objs, kw);
    });
    display_module.def("display_svg", [xint](py::args objs, py::kwargs kw) {
        xdisplay_mimetype(xint, "image/svg+xml", objs, kw);
    });
    display_module.def("display_png", [xint](py::args objs, py::kwargs kw) {
        xdisplay_mimetype(xint, "image/png", objs, kw);
    });
    display_module.def("display_jpeg", [xint](py::args objs, py::kwargs kw) {
        xdisplay_mimetype(xint, "image/jpeg", objs, kw);
    });
    display_module.def("display_latex", [xint](py::args objs, py::kwargs kw) {
        xdisplay_mimetype(xint, "text/latex", objs, kw);
    });
    display_module.def("display_json", [xint](py::args objs, py::kwargs kw) {
        xdisplay_mimetype(xint, "application/json", objs, kw);
    });
    display_module.def("display_javascript", [xint](py::args objs, py::kwargs kw) {
        xdisplay_mimetype(xint, "application/javascript", objs, kw);
    });
    display_module.def("display_pdf", [xint](py::args objs, py::kwargs kw) {
        xdisplay_mimetype(xint, "application/pdf", objs, kw);
    });

    display_module.attr("DisplayObject") = bind_display_object();
    display_module.attr("TextDisplayObject") = bind_text_display_object();
    display_module.attr("HTML") = bind_html();
    display_module.attr("Javascript") = bind_javascript();
    display_module.attr("Markdown") = bind_markdown();
    display_module.attr("Math") = bind_math();
    display_module.attr("Latex") = bind_latex();
    display_module.attr("SVG") = bind_svg();
    display_module.attr("JSON") = bind_json();
    display_module.attr("GeoJSON") = bind_geojson();
    display_module.attr("ProgressBar") = bind_progressbar();
...
py::module make_display_module(xeus::xinterpreter* xint, bool raw_mode /*false*/) {
    if (raw_mode) {
        return xpyt_raw::get_display_module_impl(xint);
    } else {
